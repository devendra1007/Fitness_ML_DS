...
outlier_coloums = list(df.columns[:6])
...
df[outlier_coloums[:3] + ["Label"]].boxplot(by="Label", figsize=(20,10), layout = (1, 3))
df[outlier_coloums[3:] + ["Label"]].boxplot(by="Label", figsize=(20,10), layout = (1, 3))
...
df[outlier_coloums[:3] + ["Label"]].plot.hist(by="Label", figsize=(20,20), layout = (3, 3))
df[outlier_coloums[3:] + ["Label"]].plot.hist(by="Label", figsize=(20,20), layout = (3, 3))
...
dataset, outliers, X_scores = mark_outliers_lof(df,outlier_coloums)
for col in outlier_coloums:
...
dataset, outliers, X_scores = mark_outliers_lof(df[df["Label"] == label],outlier_coloums)
for col in outlier_coloums:
    plot_binary_outliers(dataset=dataset,col=col,outlier_col="outlier_lof",reset_index= True)
...
outlier_removed_df.to_pickle("../../data/interim/01_outliers_removed_chauvenet.pkl")